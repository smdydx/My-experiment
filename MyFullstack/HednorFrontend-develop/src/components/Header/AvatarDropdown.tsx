  ...
  if (!token) {
    return (
      <button className="relative mt-3 sm:mt-0 flex rounded-sm bg-primary-500">
        <Link
          href="/login"
          className="flex items-center text-center font-semibold h-10 sm:h-12 px-2 sm:px-3"
        >
          <p>Login</p>
        </Link>
      </button>
        ...
        {({ open, close }) => (
          <>
            <Popover.Button
              ...
              className={`mt-3 sm:mt-auto rounded-full flex-col text-slate-700 dark:text-slate-300 w-10 h-10 sm:w-16 sm:h-16 focus:outline-none flex items-center justify-center ${
                  ...
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-xs mt-0.5 text-black font-500">
                          {data?.userRole}
                        </p>
                      </div>
                    </div>
