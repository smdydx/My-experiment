...
export const PRODUCTS: Product[] = [
    ...
    },
    {
      id: 2,
      name: 'Coat',
      description: "Brown Coat for men ",
      price: 68,
      image: productImgs[2],
      category: "Category 1",
      tags: ["tag1", "tag2"],
    ...
    },
    {
      id: 3,
      name: "Purse",
      description: "Pink Purse for woman",
      price: 132,
      image: productImgs[3],
      category: "Category 1",
      tags: ["tag1", "tag2"],
    ...
    },
    {
      ...
      description: "Green Full Sleeves T-shirt",
      price: 28,
      image: productImgs[4],
      category: "Category 1",
      tags: ["tag1", "tag2"],
    ...
    // Duplicates below with new IDs and image numbers
    {
      id: 9,
      name: "Heels",
      description: "Heels for woman",
      price: 74,
      image: productImgs[9],
      category: "Category 1",
      tags: ["tag1", "tag2"],
    ...
    },
    {
      id: 10,
      name: "Leather Gloves",
      description: "Durable leather gloves for winter protection.",
      price: 74,
    ...
    },
    {
      id: 11,
      name: "Hoodie",
      description: "A warm hoodie perfect for chilly evenings.",
      price: 74,
    ...
    },
    {
      id: 12,
      name: "Baby Sleeper",
      description: "Soft, comfortable sleeper for babies.",
      price: 74,
      image: productImgs[17],
      category: "Category 1",
      tags: ["tag1", "tag2"],
      link: "/product-detail/",
      variants: DEMO_VARIANTS,
    ...
    },
    {
      id: 13,
      name: "Black Trouser",
      description: "Classic black trouser for all occasions.",
      price: 74,
    ...
    {
      id: 14,
      name: "Full Sleeve T-shirt (Lemon Green)",
      description: "Stylish full sleeve t-shirt in refreshing lemon green color.",
      price: 74,
    ...
    },
    {
      id: 15,
      name: "Blue Mutch",
      description: "Warm and cozy blue mutch for winter.",
      price: 74,
    ...
    },
    {
      id: 16,
      name: "Pink Hoodie",
      description: "Soft and stylish pink hoodie for casual wear.",
      price: 74,
